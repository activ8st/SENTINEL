...
export default function DualIPhoneHeroMockup() {
  return (
    <div className="relative w-full flex items-center justify-center py-4 px-2 sm:py-8 select-none">
      ...
      <div className="absolute inset-0 bg-gradient-to-tr from-[#10b981]/25 via-emerald-600/15 to-amber-500/20 blur-[140px] rounded-full pointer-events-none" />
      <div className="absolute w-[320px] h-[320px] bg-[#10b981]/20 blur-[100px] rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none" />

      {/* Uncropped 3D Phone Display Wrapper */}
      <div className="relative w-full max-w-[340px] xs:max-w-[400px] sm:max-w-[460px] md:max-w-[500px] h-[480px] xs:h-[540px] sm:h-[620px] md:h-[660px] flex items-center justify-center">
        
        {/* ========================================================================= */}
        {/* PHONE 2 (BACKGROUND, LEFT) - iPhone 17 Pro Feed */}
        {/* ========================================================================= */}
          ...
          <div className="w-full h-full rounded-[2.4rem] sm:rounded-[3.0rem] bg-[#07090e] ring-1 ring-white/20 overflow-hidden flex flex-col relative text-white shadow-inner">
            ...
            <div className="px-3 pt-2 pb-2 flex items-center justify-between border-b border-white/10 shrink-0 bg-[#0a0c12]/95 backdrop-blur-md z-30">
              <div className="flex items-center gap-1.5">
                ...
                <span className="font-extrabold text-[9px] sm:text-[11px] tracking-tight">Sentinel Feed</span>
              </div>
              <span className="text-[7px] sm:text-[8px] bg-[#10b981] text-black px-2 py-0.5 rounded-full font-black tracking-wider shadow-[0_0_10px_rgba(16,185,129,0.5)]">
                LIVE 24/7
              </span>
            </div>
            ...
            <div className="flex-1 p-2 sm:p-2.5 space-y-2 overflow-hidden text-left bg-[#05070b]">
              ...
              <div className="p-2 sm:p-2.5 rounded-2xl bg-[#0e111a] border border-red-500/50 shadow-lg relative overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-1 pl-1">
                  <span className="text-[7.5px] font-black text-red-400 bg-red-500/20 border border-red-500/40 px-1.5 py-0.5 rounded-md tracking-wider">
                    🚨 CRIMINI
                  </span>
                ...
                <div className="flex items-center justify-between text-[7px] sm:text-[8px] text-white/70 pl-1 pt-1 border-t border-white/5">
              ...
              <div className="p-2 sm:p-2.5 rounded-2xl bg-[#0e111a] border border-emerald-500/40 shadow-lg relative overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-1 pl-1">
                  <span className="text-[7.5px] font-black text-emerald-400 bg-emerald-500/20 border border-emerald-500/40 px-1.5 py-0.5 rounded-md tracking-wider">
                    ⛈️ METEO UFFICIALE
                  </span>
              ...
              <div className="p-2 sm:p-2.5 rounded-2xl bg-[#0e111a] border border-amber-500/40 relative overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-1 pl-1">
                  <span className="text-[7.5px] font-black text-amber-400 bg-amber-500/20 border border-amber-500/40 px-1.5 py-0.5 rounded-md tracking-wider">
                    🚦 VIABILITÀ
                  </span>
            ...
            <div className="flex-1 relative bg-[#070910] overflow-hidden">
              ...
              <div className="absolute inset-0 opacity-85">
                <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient id="streetGlow2" x1="0%" y1="0%" x2="100%" y2="100%">
                  ...
                  <rect x="20" y="30" width="65" height="55" rx="6" fill="#111622" stroke="#1f293d" strokeWidth="1.5" />
                  <rect x="100" y="20" width="75" height="45" rx="6" fill="#111622" stroke="#1f293d" strokeWidth="1.5" />
                  <rect x="185" y="45" width="60" height="70" rx="6" fill="#111622" stroke="#1f293d" strokeWidth="1.5" />

                  <rect x="15" y="115" width="80" height="65" rx="6" fill="#111622" stroke="#1f293d" strokeWidth="1.5" />
                  <rect x="110" y="145" width="70" height="60" rx="6" fill="#111622" stroke="#1f293d" strokeWidth="1.5" />

                  {/* Main Glowing Arteries */}
                  <path d="M-10 100 L 280 100" stroke="url(#streetGlow2)" strokeWidth="5.5" fill="none" strokeLinecap="round" />
                  <path d="M95 -10 L 95 300" stroke="url(#streetGlow2)" strokeWidth="5" fill="none" strokeLinecap="round" />
                  <path d="M180 -10 L 180 300" stroke="#334155" strokeWidth="2.5" strokeDasharray="4 3" fill="none" />

                  {/* Radar Sonar Waves */}
                  <circle cx="95" cy="100" r="52" stroke="#10b981" strokeWidth="1.5" strokeOpacity="0.5" fill="#10b981" fillOpacity="0.06" strokeDasharray="3 3" />
                  <circle cx="95" cy="100" r="80" stroke="#10b981" strokeWidth="1" strokeOpacity="0.25" fill="none" />
                </svg>
              </div>
              ...
              {/* ========================================================================= */}
              {/* 100% CONTAINED SLEEK CITIZEN ALERT CARD (FULLY INSIDE DISPLAY) */}
              {/* ========================================================================= */}
              <div className="absolute bottom-3 left-2.5 right-2.5 bg-[#0b0e17]/98 border border-[#10b981]/60 p-2.5 sm:p-3 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.95)] backdrop-blur-2xl flex items-center justify-between gap-2 z-30">
